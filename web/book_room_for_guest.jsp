...
<body>
    <div class="topnav">
        <a >Sun Shine Hotel</a>
            ...
            <a class="admin1">All Room List</a>  
			...
			<tr>
                                 ...
                                 <td><%=rs.getString(4)%></td>
                                  <td><%=rs.getString(5)%></td>
                                   ...
                                   <td><a class="link-light"  href="book_room_button_action.jsp?id=<%=rs.getString(1)%>&class=<%=rs.getString(2)%>&bed=<%=rs.getString(3)%>&floor=<%=rs.getString(4)%>&ac=<%=rs.getString(5)%>&price=<%=rs.getString(6)%>">Book Room</a></td>
			</tr>   
